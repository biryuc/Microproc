...
uint8_t eeWriteByte(uint16_t address,uint8_t ArrayBytes[10]);//Запись байта в модуль памяти EEPROM
uint8_t eeReadByte(uint16_t address,uint8_t *data); //Чтение байта из модуля памяти EEPROM
